...
class Ui_pubCommentGUI(object):
    def setupUi(self, pubCommentGUI):
        pubCommentGUI.setObjectName("pubCommentGUI")
        pubCommentGUI.setEnabled(True)
        pubCommentGUI.resize(330, 282)
        self.centralwidget = QtGui.QWidget(pubCommentGUI)
        ...
        self.mid_HBoxLayout.addWidget(self.plainTextEdit)
        ...
        self.assetTyleLable = QtGui.QLabel(self.centralwidget)
        self.assetTyleLable.setObjectName("assetTyleLable")
        self.top_GridLayout.addWidget(self.assetTyleLable, 3, 1, 1, 1)
        ...
        pubCommentGUI.setCentralWidget(self.centralwidget)

        self.retranslateUi(pubCommentGUI)
        QtCore.QMetaObject.connectSlotsByName(pubCommentGUI)
    ...
    def retranslateUi(self, pubCommentGUI):
        ...
        self.assetTyleLable.setText(QtGui.QApplication.translate("pubCommentGUI", "styleframes", None, QtGui.QApplication.UnicodeUTF8))
